...
#define STATIC_N(X) static int STATIC_UNIQUE_IDENTIFIER(b_static_flag_blocker_) = 1; if((STATIC_UNIQUE_IDENTIFIER(b_static_flag_blocker_) <= X) && (STATIC_UNIQUE_IDENTIFIER(b_static_flag_blocker_)++))
